...
export const metadata: Metadata = {
  title: "Klear® | At-Home Ketamine Treatment - Coming Soon",
  description:
    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div className="mb-8 animate-fade-in">
          <span className="text-3xl font-bold text-[var(--klear-neutral-900)]">
            Klear<span className="text-[var(--klear-primary-600)]">®</span>
          </span>
        </div>
