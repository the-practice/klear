...
export default function WashingtonPage() {
  ...
  return (
    <div className="pt-16">
      ...
      <section className="py-20 lg:py-28 gradient-hero relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-15">
          <ImagePlaceholder
            id="8a"
            aspectRatio="banner"
            description="Washington landscape - mountains, evergreens, Seattle skyline"
      ...
      {/* Washington Scenic Image - Edge to Edge */}
      <section className="relative">
        <ImagePlaceholder
          id="8b"
          aspectRatio="wide"
          description="Washington panoramic - Mt. Rainier, Puget Sound, or forest - Edge to Edge"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-right opacity-0" style={{ animationFillMode: 'forwards' }}>
              <ImagePlaceholder
                id="8c"
                aspectRatio="square"
                description="Washington lifestyle - cozy home with rainy window view"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden">
            <ImagePlaceholder
              id="8d"
              aspectRatio="square"
              description="Washington patient portrait - tech professional"
              className="w-full h-full rounded-none border-0"
            />
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-[var(--klear-primary-600)] to-[var(--klear-primary-800)] relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <ImagePlaceholder
            id="8e"
            aspectRatio="wide"
            description="Mountain/forest silhouettes pattern"
            className="w-full h-full rounded-none border-0"
          />
        </div>
