...
export const metadata: Metadata = {
  ...
  description: "Get FDA-approved ketamine treatment in Tallahassee, Florida from licensed psychiatric providers. At-home therapy with medical supervision. Serving Leon County and the Big Bend region.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Get FDA-approved ketamine treatment in Tallahassee from licensed psychiatric providers. At-home therapy for depression, anxiety, PTSD.",
    type: "website",
  },
};
